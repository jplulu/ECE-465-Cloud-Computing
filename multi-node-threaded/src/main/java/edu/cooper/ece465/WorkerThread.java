...
public class WorkerThread extends Thread {
    ...
    public WorkerThread(Graph graph, int startNode, int endNode, Set<Integer> visitedNodes, PriorityQueue<Node> nodeQueue, List<Integer> nodeDistances, Node minNode, CyclicBarrier barrier, AtomicBoolean isFinished) {
        this.graph = graph;
